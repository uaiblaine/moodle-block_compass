...
$string['enable_page'] = 'Enable the Compass page';
$string['enable_page_desc'] = 'Serve the block\'s content on a page of its own, /blocks/compass/index.php, with only the theme\'s navigation bar and footer around it - no block regions, no other blocks. While enabled, "Compass" is offered as a choice for "Start page for users" (Site administration > Appearance > Navigation) and, when that setting leaves the choice to users, in each user\'s own preferences. Off, the page redirects to the Dashboard.';
...
$string['hide_page_title'] = 'Hide the page title';
$string['hide_page_title_desc'] = 'Show the Compass page without the theme\'s page heading, so the content starts closer to the navigation bar. The title stays in the page as a visually hidden level-one heading for assistive technology. Only the page is affected; the block on the Dashboard follows "Hide the block title".';
