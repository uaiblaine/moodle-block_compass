...
$string['badge_pending'] = 'Aguardando aprovação';
$string['cachedef_categorymeta'] = 'Nomes, caminhos e contextos das categorias, compartilhados por todos os usuários';
$string['cachedef_coursefields'] = 'Valores dos campos personalizados de curso, compartilhados por todos os usuários';
...
$string['enable_page'] = 'Habilitar a página do Compass';
$string['enable_page_desc'] = 'Serve o conteúdo do bloco numa página própria, /blocks/compass/index.php, só com a barra de navegação e o rodapé do tema ao redor - sem regiões de blocos, sem outros blocos. Enquanto habilitada, "Compass" é oferecido como opção em "Página inicial para usuários" (Administração do site > Aparência > Navegação) e, quando essa configuração deixa a escolha ao usuário, nas preferências de cada um. Desabilitada, a página redireciona para o Painel.';
$string['enable_pending'] = 'Mostrar solicitações de inscrição aguardando aprovação';
$string['enable_pending_desc'] = 'Lista na lista completa de cursos as solicitações de inscrição que você enviou e que ainda aguardam decisão — uma linha com o selo "Aguardando aprovação" na categoria dela, um chip "Aguardando aprovação" no painel de filtros e uma linha de aviso sob Novas inscrições. Requer o plugin Inscrição por solicitação (enrol_apply); sem ele esta configuração não faz nada.';
...
$string['filter_fields'] = 'Campos personalizados de curso oferecidos como filtros';
$string['filter_fields_desc'] = 'Cada campo selecionado vira um grupo de chips no painel de filtros da lista completa de cursos. Só são oferecidos campos dos tipos Menu suspenso e Caixa de seleção visíveis a todos, e no máximo {$a} são usados, nesta ordem.';
$string['filter_fields_none'] = 'Ainda não há campo personalizado de curso do tipo Menu suspenso ou Caixa de seleção visível a todos. Crie um em Administração do site > Cursos > Campos personalizados de curso e ele passa a ser oferecido aqui.';
$string['filteractive'] = '{$a} filtros ativos';
$string['filterby'] = 'Filtrar cursos';
$string['filterpanel'] = 'Filtros';
...
$string['hide_page_title'] = 'Ocultar o título da página';
$string['hide_page_title_desc'] = 'Exibe a página do Compass sem o cabeçalho de página do tema, para o conteúdo começar mais perto da barra de navegação. O título permanece na página como um título de nível um visualmente oculto, para tecnologia assistiva. Só a página é afetada; o bloco no Painel segue "Ocultar o título do bloco".';
...
$string['pendingmeta'] = 'Acesso após a aprovação';
$string['pendingnotice'] = '{$a} solicitações de inscrição aguardando aprovação';
$string['pendingnoticelabel'] = 'Ver as solicitações de inscrição aguardando aprovação na lista completa de cursos';
$string['pendingnoticeview'] = 'ver';
...
$string['strip_more_favourites'] = '+{$a} favoritos';
$string['strip_more_favourites_label'] = 'Ver os outros {$a} favoritos na lista completa de cursos';
$string['strip_more_new'] = '+{$a} novos';
$string['strip_more_new_label'] = 'Ver as outras {$a} novas inscrições na lista completa de cursos';
