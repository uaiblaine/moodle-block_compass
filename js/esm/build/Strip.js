import{useId as u}from"react";import b from"./Card";import g from"./Ghost";import{sectionTag as v}from"./heading";import{jsx as t,jsxs as e}from"react/jsx-runtime";var f=({title:m,name:d,cards:o,ghost:i,overflow:s,config:r,onToggleFavourite:p,onExplore:a})=>{let n=u(),c=v(r.titlehidden);return o.length?e("section",{className:"compass-strip","data-strip":d,"aria-labelledby":n,children:[e("div",{className:"compass-strip-head",children:[t(c,{className:"compass-strip-title h6 fw-bold text-muted mb-0",id:n,children:m}),s&&t("button",{type:"button",className:"btn btn-link btn-sm p-0 compass-strip-more","aria-label":s.label,onClick:()=>a(s.kind),children:s.text})]}),t("div",{className:"compass-cards",children:e("div",{className:"compass-cards-list",role:"list",children:[o.map(l=>t("div",{className:"compass-cards-item",role:"listitem",children:t(b,{card:l,config:r,onToggleFavourite:p})},l.id)),i&&t("div",{className:"compass-cards-item",role:"listitem",children:t(g,{count:i.count,text:i.text,cta:i.cta,kind:"tier2",onExplore:a})})]})})]}):null},C=f;export{C as default};
/**
